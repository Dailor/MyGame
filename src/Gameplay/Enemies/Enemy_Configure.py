...
Piranha_Plant = [load_image(['Gameplay/Enemies/piranha-plant', 'piranha-plant-1.png']),
                 ...
                 load_image(['Gameplay/Enemies/piranha-plant', 'piranha-plant-3.png']),
                 load_image(['Gameplay/Enemies/piranha-plant', 'piranha-plant-4.png'])]

Piranha_Plant_Attack = [load_image(['Gameplay/Enemies/piranha-plant-attack', 'piranha-plant-attack-1.png']),
                        load_image(['Gameplay/Enemies/piranha-plant-attack', 'piranha-plant-attack-2.png']),
